...
class _SimpleSegmentationModel(nn.Module):
    ...
    def forward(self, x):
        ...
        x, heatmap, heatmap_boundary = self.classifier(features)
        x = F.interpolate(x, size=input_shape, mode='bilinear', align_corners=False)
        heatmap = F.interpolate(heatmap, size=input_shape, mode='bilinear', align_corners=False)
        heatmap_boundary = F.interpolate(heatmap_boundary, size=input_shape, mode='bilinear', align_corners=False)
        return x, heatmap, heatmap_boundary
